 ...
 * @file hash-ull.h
 *
 * Hash function for a pointer to an unsigned long long.  See @ref ull_hash.
 */

#ifndef ALGORITHM_HASH_ULL_H
#define ALGORITHM_HASH_ULL_H
...
#endif /* #ifndef ALGORITHM_HASH_ULL_H */
